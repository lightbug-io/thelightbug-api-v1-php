 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeviceConfig implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'home_wifi_password' => 'setHomeWifiPassword',
    ...
    protected static $getters = [
        ...
        'home_wifi_password' => 'getHomeWifiPassword',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['mode_control2'] = isset($data['mode_control2']) ? $data['mode_control2'] : null;
        ...
        $this->container['home_wifi_password'] = isset($data['home_wifi_password']) ? $data['home_wifi_password'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sleep_interval'] === null) {
            $invalidProperties[] = "'sleep_interval' can't be null";
        }
        if ($this->container['packing'] === null) {
            $invalidProperties[] = "'packing' can't be null";
        }
        if (!is_null($this->container['home_wifi_network']) && (mb_strlen($this->container['home_wifi_network']) > 127)) {
            $invalidProperties[] = "invalid value for 'home_wifi_network', the character length must be smaller than or equal to 127.";
        }

        if (!is_null($this->container['home_wifi_password']) && (mb_strlen($this->container['home_wifi_password']) > 127)) {
            $invalidProperties[] = "invalid value for 'home_wifi_password', the character length must be smaller than or equal to 127.";
        }

        if ($this->container['wake_action'] === null) {
            $invalidProperties[] = "'wake_action' can't be null";
        }
        if ($this->container['on_demand_time'] === null) {
            $invalidProperties[] = "'on_demand_time' can't be null";
        }
        if ($this->container['alert_action'] === null) {
            $invalidProperties[] = "'alert_action' can't be null";
        }
     ...
     *
     * @param float $check_in_interval DEPRECATED A failsafe to ensure the unit connects to the server at least this often.
     *
     * @return $this
     */
     ...
     * @return float
     */
    public function getModeControl2()
    {
        return $this->container['mode_control2'];
    }

    /**
     * Sets mode_control2
     *
     * @param float $mode_control2 Char Bitfield with various flags. Advanced use only. FW >= 69.  SendStopImmediately:1 |  StopTimeoutIsInMinutes:2 |  HarshPowerBudget:4 |  Lock2G: 8
     *
     * @return $this
     */
    public function setModeControl2($mode_control2)
    {
        $this->container['mode_control2'] = $mode_control2;
     ...
     *
     * @param float $tolerance_percentage Power budget in mAh per location update. Default 10, do not set lower than 5.
     *
     * @return $this
     */
     ...
     *
     * @param object[] $reasons_to_wake reasons_to_wake
     *
     * @return $this
     */
    ...
    {
        if (!is_null($home_wifi_network) && (mb_strlen($home_wifi_network) > 127)) {
    ...
    /**
     * Gets home_wifi_password
     *
     * @return string
     */
    public function getHomeWifiPassword()
    {
        return $this->container['home_wifi_password'];
    }

    /**
     * Sets home_wifi_password
     *
     * @param string $home_wifi_password WiFi network paswword. If set enables transmission over WiFi.
     *
     * @return $this
     */
    public function setHomeWifiPassword($home_wifi_password)
    {
        if (!is_null($home_wifi_password) && (mb_strlen($home_wifi_password) > 127)) {
            throw new \InvalidArgumentException('invalid length for $home_wifi_password when calling DeviceConfig., must be smaller than or equal to 127.');
        }

        $this->container['home_wifi_password'] = $home_wifi_password;
     ...
     * Sets wake_action
     *
     * @param string $wake_action Internal Use Only. What to do when the unit wakes up (ie is moved and not in a safe-zone). Options are 'available' (lost and found), and 'normal' (tracking)
     *
     * @return $this
     */
     ...
     * Sets safe_zone_id
     *
     * @param float $safe_zone_id safe_zone_id
     *
     * @return $this
     */
